...
})({"cJMth":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "2d241a12ef88152f";
"use strict";
...
},{}],"boBGR":[function(require,module,exports) {
...
},{"./login":"7dQ71","./updateSettings":"1izqm","./stripe":"1Pi9W"}],"7dQ71":[function(require,module,exports) {
...
const login = async (email, password)=>{
    ...
    try {
        ...
        if (res.data.status === 'success') {
            _alert.showAlert('success', 'Logged in succesfully');
            window.setTimeout(()=>{
                location.assign('/');
            }, 1500);
        }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","./alert":"f61Ve"}],"JacNc":[function(require,module,exports) {
...
},{}],"f61Ve":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"1izqm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const updateSettings = async (data, type)=>{
    try {
        ...
        if (res.data.status === 'success') {
            _alert.showAlert('success', `${type.toUpperCase()} updated successfully!`);
            console.log('success');
        }
    } catch (err) {
        _alert.showAlert('error', err.response.data.message);
...
},{"axios":"iYoWk","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","./alert":"f61Ve"}],"iYoWk":[function(require,module,exports) {
...
},{"./../utils":"hOPY0"}],"1Pi9W":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alert = require("./alert");
const stripe = Stripe('pk_test_51LBaClSB3EQZtGG5QZm6sqq7t3MmN7fmXlSuBpOQsIJJ8FrLpIjCDxxChfLkfzvCqm4hkitNPYlAUkOlar5aqWdw00rZSedQvd');
...
},{"axios":"iYoWk","./alert":"f61Ve","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["cJMth","boBGR"], "boBGR", "parcelRequire11c7")
